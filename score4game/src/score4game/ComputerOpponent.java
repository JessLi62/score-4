        ...
        while (commandReader.hasNext()) {
            ...
            switch (command) {
                case "restart;":
                    ...
                    break;
                case "play":
                    if (commandReader.nextLine().equalsIgnoreCase(" black;")) {
                ...
                case "move;":
                    responseWriter.println(myMoves.getMove(myBoard, myColor));
                    break;
                case "note:":
                    opponentMove = (commandReader.nextLine()).split(" ");
                    myBoard.addBead(new Location(opponentMove[3].substring(0, 2)), myColor.getOppositeColor());
                    responseWriter.println("ok.");
                    break;
                default:
                    responseWriter.println("Bad command.");
            }
